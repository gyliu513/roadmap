...
from egodocker.common import lockutils
from egodocker.common import log as logging
from egodocker.common import processutils
...
CONF.import_opt('network_api_class', 'egodocker.network')
...
synchronized = lockutils.synchronized_with_prefix('egodocker-')
...
def is_neutron():
    ...
    try:
        ...
        if cls_name == 'egodocker.network.quantumv2.api.API':
            cls_name = 'egodocker.network.neutronv2.api.API'

        from egodocker.network.neutronv2 import api as neutron_api
